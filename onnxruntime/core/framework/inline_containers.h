...
template <typename T>
using InlinedHashSet = absl::flat_hash_set<T, absl::container_internal::hash_default_hash<T>,
                                          absl::container_internal::hash_default_eq<T>,
                                          std::pmr::polymorphic_allocator<T>>;

template <typename K, typename V>
using InlinedHashMap = absl::flat_hash_map<K, V, absl::container_internal::hash_default_hash<K>,
