...
class PadBase {
 ...
 protected:
  ...
  TensorShapeVector pads_;       // After construction, only >=0 values are in here
  TensorShapeVector slices_;  // All of the negative padding values are separated out into slices_
