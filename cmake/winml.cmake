...
# Link libraries
target_link_libraries(winml_lib_telemetry PRIVATE wil winml_lib_common)
target_link_libraries(winml_lib_telemetry PRIVATE winml_api)
...
target_link_libraries(winml_lib_ort PRIVATE winml_api)

target_link_libraries(winml_lib_ort PUBLIC  winml_lib_api)
...
target_link_libraries(winml_adapter PRIVATE onnxruntime_common onnxruntime_framework onnx onnx_proto ${PROTOBUF_LIB} flatbuffers)
...
# Includes - public interface
target_include_directories(winml_adapter PUBLIC ${winml_adapter_dir})
...
# Link libraries
target_link_libraries(winml_adapter PRIVATE wil winml_lib_common)
if (onnxruntime_USE_DML)
...
# Includes - Public Interface
target_include_directories(winml_lib_image INTERFACE ${winml_lib_api_image_dir}/inc)
...
target_link_libraries(winml_lib_image PRIVATE winml_api)
target_link_libraries(winml_lib_image PRIVATE winml_lib_api)
...
# Includes - Public Interface
target_include_directories(winml_lib_api PUBLIC ${winml_lib_api_dir})
target_include_directories(winml_lib_api PUBLIC ${winml_lib_api_dir}/pch)
...
target_link_libraries(winml_lib_api PRIVATE winml_lib_image)
...
target_link_libraries(winml_lib_api_experimental PRIVATE winml_lib_image)
target_link_libraries(winml_lib_api_experimental PRIVATE winml_lib_api)
...
target_link_libraries(winml_lib_common PRIVATE winml_api)
